          ...
          return (
            <Form className="d-flex flex-column align-items-center justify-conetent-center border-info rounded mt-3">
              <div className="mb-4">
                ...
                <Field name="name" type="text" value={prop.values.name} className="d-block rounded form-control" placeholder="Theater name" size='50'/>
                <ErrorMessage
                  name="name"
              ...
              <div className="mb-4">
                <label className="d-block font-weight-bold">Address Line1</label>
                <Field name="addressLine1" type="text" value={prop.values.addressLine1} className="d-block rounded form-control" placeholder="Address" size='50'/>
                <ErrorMessage
                  name="addressLine1"
                  render={(msg) => <small className="d-block text-danger">{msg}</small>}
                />
              ...
              <div className="mb-4">
                <label className="d-block font-weight-bold">Address Line2</label>
                <Field name="addressLine2" type="text" value={prop.values.addressLine2} className="d-block rounded form-control" placeholder="Address" size='50'/>
                <ErrorMessage
                  name="addressLine2"
                  render={(msg) => <small className="d-block text-danger">{msg}</small>}
                />
              ...
              <div className="mb-4">
                ...
                <Field name="city" type="text" value={prop.values.city} className="d-block rounded form-control" placeholder="City" size='50'/>
                <ErrorMessage
                  name="city"
                  render={(msg) => <small className="d-block text-danger">{msg}</small>}
                />
              ...
              <div className="mb-4">
                ...
                <Field name="state" type="text" value={prop.values.state} className="d-block rounded form-control" placeholder="State" size='50'/>
                <ErrorMessage
                  name="state"
                  render={(msg) => <small className="d-block text-danger">{msg}</small>}
                />
              ...
              <div className="mb-4">
                ...
                <Field name="pincode" type="text" value={prop.values.pincode} maxLength='6' minLength='6' className="d-block rounded form-control" placeholder="Pin Code" size='50'/>
                <ErrorMessage
                  name="pincode"
                  render={(msg) => <small className="d-block text-danger">{msg}</small>}
                />
              ...
              <div className="mb-4">
                ...
                <Field name="country" type="text" value={prop.values.country} className="d-block rounded form-control" placeholder="Country" size='50'/>
                <ErrorMessage
                  name="country"
                  render={(msg) => <small className="d-block text-danger">{msg}</small>}
                />
              ...
              <div className="d-flex justify-content-between">
                    {props.id? <button type='submit' className="btn btn-info mr-4">Update</button>
                    : <button type='submit' className="btn btn-info mr-4" >Add</button>}
                    
                    <button type='button' className="btn btn-info" onClick={()=>{setShowEdit(false); setId('')}}>Cancel</button>
                </div>
            </Form>
          );
        }}
